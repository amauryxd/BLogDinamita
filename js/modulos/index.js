    ...
    get(child(dbRef, `Publicacion`)).then((snapshot) => {
        if (snapshot.exists()) {
            ...
            for(let clave in data){
                ...
                postul.innerHTML += `
                <div class="container my-3 bg-secondary rounded">
                    <div class="container py-5 bg-secondary rounded-bottom text-center">
                    ...
                    <div class="container bg-secondary rounded py-4 my-2">
                        <div class="row">
